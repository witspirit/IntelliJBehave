...
public class JBehaveNarrativeTextImpl extends ParserRule implements JBehaveNarrativeText {

  public JBehaveNarrativeTextImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof JBehaveVisitor) ((JBehaveVisitor)visitor).visitNarrativeText(this);
