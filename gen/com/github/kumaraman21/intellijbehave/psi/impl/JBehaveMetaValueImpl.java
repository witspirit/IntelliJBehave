...
public class JBehaveMetaValueImpl extends ParserRule implements JBehaveMetaValue {

  public JBehaveMetaValueImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof JBehaveVisitor) ((JBehaveVisitor)visitor).visitMetaValue(this);
