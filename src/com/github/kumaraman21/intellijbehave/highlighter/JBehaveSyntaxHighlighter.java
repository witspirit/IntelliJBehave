...
public class JBehaveSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    @NonNls
    private static final String JB_DESCRIPTION_ID = "JBEHAVE.JB_DESCRIPTION";
    private static final String JB_EXAMPLES_ID = "JBEHAVE.JB_EXAMPLES";
    ...
    private static final String JB_IP_ADDRESS_ID = "JBEHAVE.JB_IP_ADDRESS";
    //public static final String JB_LIFECYCLE_ID = "JBEHAVE.JB_LIFECYCLE";
    private static final String JB_LIFECYCLE_AFTER_ID = "JBEHAVE.JB_LIFECYCLE_AFTER";
    private static final String JB_LIFECYCLE_BEFORE_ID = "JBEHAVE.JB_LIFECYCLE_BEFORE";
    //public static final String JB_META_ELEMENT_ID = "JBEHAVE.JB_META_ELEMENT";
    private static final String JB_META_KEY_ID = "JBEHAVE.JB_META_KEY";
    //public static final String JB_META_STATEMENT_ID = "JBEHAVE.JB_META_STATEMENT";
    private static final String JB_META_VALUE_ID = "JBEHAVE.JB_META_VALUE";
    ...
    private static final String JB_NARRATIVE_TEXT_ID = "JBEHAVE.JB_NARRATIVE_TEXT";
    ...
    private static final String JB_SCENARIO_TITLE_ID = "JBEHAVE.JB_SCENARIO_TITLE";
    ...
    private static final String JB_STEP_LINE_ID = "JBEHAVE.JB_STEP_LINE";
    //public static final String JB_STEP_PAR_ID = "JBEHAVE.JB_STEP_PAR";
    private static final String JB_STEP_POST_PARAMETER_ID = "JBEHAVE.JB_STEP_POST";
    private static final String JB_JB_ID = "JBEHAVE.JB_JBEHAVE";
    //public static final String JB_JB_PATH_ID = "JBEHAVE.JB_JB_PATH";
    //public static final String JB_JB_PATHS_ID = "JBEHAVE.JB_JB_PATHS";
    private static final String JB_TABLE_ID = "JBEHAVE.JB_TABLE";
    //public static final String JB_TABLE_CELL_EMPTY_ID = "JBEHAVE.JB_TABLE_CELL_EMPTY";
    private static final String JB_TABLE_CELL_ID = "JBEHAVE.JB_TABLE_CELL";
    private static final String JB_TABLE_ROW_ID = "JBEHAVE.JB_TABLE_ROW";
    ...
    private static final String JB_ERROR_NO_DEF_FOUND_ID = "JBEHAVE.ERROR_NO_DEF_FOUND";
    private static final String JB_ERROR_FILE_NOT_FOUND_ID = "JBEHAVE.FILE_NOT_FOUND_ID";
    private static final String JB_TOKEN_AFTER_ID = "JBEHAVE.JB_TOKEN_AFTER";
    private static final String JB_TOKEN_AND_ID = "JBEHAVE.JB_TOKEN_AND";
    private static final String JB_TOKEN_BEFORE_ID = "JBEHAVE.JB_TOKEN_BEFORE";
    private static final String JB_TOKEN_EXAMPLES_ID = "JBEHAVE.JB_TOKEN_EXAMPLES";
    private static final String JB_TOKEN_GIVEN_STORIES_ID = "JBEHAVE.JB_TOKEN_GIVEN_STORIES";
    private static final String JB_TOKEN_GIVEN_ID = "JBEHAVE.JB_TOKEN_GIVEN";
    private static final String JB_TOKEN_LIFECYCLE_ID = "JBEHAVE.JB_TOKEN_LIFECYCLE";
    private static final String JB_TOKEN_META_ID = "JBEHAVE.JB_TOKEN_META";
    private static final String JB_TOKEN_NARRATIVE_ID = "JBEHAVE.JB_TOKEN_NARRATIVE";
    private static final String JB_TOKEN_SCENARIO_ID = "JBEHAVE.JB_TOKEN_SCENARIO";
    private static final String JB_TOKEN_THEN_ID = "JBEHAVE.JB_TOKEN_THEN";
    private static final String JB_TOKEN_WHEN_ID = "JBEHAVE.JB_TOKEN_WHEN";
    private static final String JB_TOKEN_PIPE_ID = "JBEHAVE.JB_TOKEN_PIPE";
    private static final String JB_TOKEN_INJECT_ID = "JBEHAVE.JB_TOKEN_INJECT";
    private static final String JB_TOKEN_USER_INJECT_ID = "JBEHAVE.JB_TOKEN_USER_INJECT";
    private static final String JB_TOKEN_COMMENT_ID = "JBEHAVE.JB_COMMENT_ID";
    private static final String STEP_PARAMETER_ID = "JBEHAVE.STEP_PARAMETER";
    //public static final String JB_TOKEN_PATH_ID = "JBEHAVE.JB_TOKEN_PATH";
    private static final String JB_DEFAULT_TEXT_ID = "JBEHAVE.JB_DEFAULT_TEXT";
    private static final String JB_STORY_PATH_ID = "JBEHAVE.JB_STORY_PATH";
    ...
    public static final TextAttributesKey JB_DESCRIPTION = createTextAttributesKey(JB_DESCRIPTION_ID);
    private static final TextAttributesKey JB_EXAMPLES = createTextAttributesKey(JB_EXAMPLES_ID);
    //public static TextAttributesKey JB_GIVEN_STORIES = createTextAttributesKey(JB_GIVEN_STORIES_ID);
    public static final TextAttributesKey JB_IP_ADDRESS = createTextAttributesKey(JB_IP_ADDRESS_ID);
    // public static TextAttributesKey JB_LIFECYCLE = createTextAttributesKey(JB_LIFECYCLE_ID);
    private static final TextAttributesKey JB_LIFECYCLE_AFTER = createTextAttributesKey(JB_LIFECYCLE_AFTER_ID);
    private static final TextAttributesKey JB_LIFECYCLE_BEFORE = createTextAttributesKey(JB_LIFECYCLE_BEFORE_ID);
    // public static TextAttributesKey JB_META_ELEMENT = createTextAttributesKey(JB_META_ELEMENT_ID);
    public static final TextAttributesKey JB_META_KEY = createTextAttributesKey(JB_META_KEY_ID);
    // public static TextAttributesKey JB_META_STATEMENT = createTextAttributesKey(JB_META_STATEMENT_ID);
    public static final TextAttributesKey JB_META_VALUE = createTextAttributesKey(JB_META_VALUE_ID);
    ...
    public static final TextAttributesKey JB_NARRATIVE_TEXT = createTextAttributesKey(JB_NARRATIVE_TEXT_ID);
    ...
    public static final TextAttributesKey JB_SCENARIO_TITLE = createTextAttributesKey(JB_SCENARIO_TITLE_ID);
    ...
    public static final TextAttributesKey JB_STEP_LINE = createTextAttributesKey(JB_STEP_LINE_ID);
    //    public static TextAttributesKey JB_STEP_PAR = createTextAttributesKey(JB_STEP_PAR_ID);
    public static final TextAttributesKey JB_STEP_POST_PARAMETER = createTextAttributesKey(JB_STEP_POST_PARAMETER_ID);
    ...
    public static final TextAttributesKey JB_STORY_PATH = createTextAttributesKey(JB_STORY_PATH_ID);
    public static final TextAttributesKey JB_TABLE = createTextAttributesKey(JB_TABLE_ID);
    public static final TextAttributesKey JB_TABLE_CELL = createTextAttributesKey(JB_TABLE_CELL_ID);
    //    public static TextAttributesKey JB_TABLE_CELL_EMPTY = createTextAttributesKey(JB_TABLE_CELL_EMPTY_ID);
    public static final TextAttributesKey JB_TABLE_ROW = createTextAttributesKey(JB_TABLE_ROW_ID);
    ...
    public static final TextAttributesKey STEP_PARAMETER = createTextAttributesKey(STEP_PARAMETER_ID);
    private static final TextAttributesKey JB_TOKEN_AFTER = createTextAttributesKey(JB_TOKEN_AFTER_ID);
    public static final TextAttributesKey JB_TOKEN_AND = createTextAttributesKey(JB_TOKEN_AND_ID);
    private static final TextAttributesKey JB_TOKEN_BEFORE = createTextAttributesKey(JB_TOKEN_BEFORE_ID);
    private static final TextAttributesKey JB_TOKEN_EXAMPLES = createTextAttributesKey(JB_TOKEN_EXAMPLES_ID);
    public static final TextAttributesKey JB_TOKEN_GIVEN = createTextAttributesKey(JB_TOKEN_GIVEN_ID);
    public static final TextAttributesKey JB_TOKEN_GIVEN_STORIES = createTextAttributesKey(JB_TOKEN_GIVEN_STORIES_ID);
    private static final TextAttributesKey JB_TOKEN_LIFECYCLE = createTextAttributesKey(JB_TOKEN_LIFECYCLE_ID);
    public static final TextAttributesKey JB_TOKEN_META = createTextAttributesKey(JB_TOKEN_META_ID);
    public static final TextAttributesKey JB_TOKEN_NARRATIVE = createTextAttributesKey(JB_TOKEN_NARRATIVE_ID);
    public static final TextAttributesKey JB_TOKEN_SCENARIO = createTextAttributesKey(JB_TOKEN_SCENARIO_ID);
    public static final TextAttributesKey JB_TOKEN_THEN = createTextAttributesKey(JB_TOKEN_THEN_ID);
    public static final TextAttributesKey JB_TOKEN_WHEN = createTextAttributesKey(JB_TOKEN_WHEN_ID);
    public static final TextAttributesKey JB_TOKEN_PIPE = createTextAttributesKey(JB_TOKEN_PIPE_ID);
    public static final TextAttributesKey JB_TOKEN_INJECT = createTextAttributesKey(JB_TOKEN_INJECT_ID);
    public static final TextAttributesKey JB_TOKEN_USERINJECT = createTextAttributesKey(JB_TOKEN_USER_INJECT_ID);
    public static final TextAttributesKey JB_TOKEN_COMMENT = createTextAttributesKey(JB_TOKEN_COMMENT_ID);
    //public static TextAttributesKey JB_TOKEN_PATH = createTextAttributesKey(JB_TOKEN_PATH_ID);
    public static final TextAttributesKey JB_ERROR_NO_DEF_FOUND = createTextAttributesKey(JB_ERROR_NO_DEF_FOUND_ID);
    public static final TextAttributesKey JB_ERROR_FILE_NOT_FOUND = createTextAttributesKey(JB_ERROR_FILE_NOT_FOUND_ID);
